                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <MotionWrapper delay={0.3}>
                        <p className="text-lg text-slate-600 mb-12 leading-relaxed">
                            Gym Mitra is flagship product of eMitra Technologies, a team obsessed
                            with solving India's small business challenges through intelligent automation.
                        </p>
                    </MotionWrapper>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                        ...
                        <MotionWrapper delay={0.5} className="h-full">
                            <div className="bg-white/60 rounded-3xl p-8 border border-slate-200/50 shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col group opacity-80">
                                ...
                                <h3 className="text-xl font-bold text-slate-400 group-hover:text-slate-900 transition-colors mb-2">School Mitra</h3>
                                <p className="text-sm text-slate-400 group-hover:text-slate-500 transition-colors mb-4 flex-1">
                                    Next-gen education ERP for modern Indian schools and coaching centers.
                                </p>
                                <span className="inline-flex items-center px-3 py-1 rounded-full bg-slate-100 text-slate-500 text-xs font-bold w-fit">
                                    Coming Q3 2026
                                </span>
                            </div>
                        </MotionWrapper>
                        ...
                        <MotionWrapper delay={0.6} className="h-full">
                            <div className="bg-white/60 rounded-3xl p-8 border border-slate-200/50 shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col group opacity-80">
                                ...
                                <h3 className="text-xl font-bold text-slate-400 group-hover:text-slate-900 transition-colors mb-2">Clinic Mitra</h3>
                                <p className="text-sm text-slate-400 group-hover:text-slate-500 transition-colors mb-4 flex-1">
                    ...
                    <MotionWrapper delay={0.7} className="mt-16">
                        <p className="text-sm font-medium text-slate-400 flex items-center justify-center gap-2">
                            ...
                            <a href="https://emitra.tech" target="_blank" className="text-primary hover:underline font-bold inline-flex items-center">
                                emitra.tech
