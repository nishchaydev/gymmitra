...
export function Navbar() {
    ...
    return (
        ...
        >
            ...
            {/* Mobile Menu Overlay */}
            <div className={cn("fixed inset-0 z-40 bg-drift-900/60 backdrop-blur-sm transition-all duration-300 md:hidden", isMobileMenuOpen ? "opacity-100 visible" : "opacity-0 invisible")} onClick={() => setIsMobileMenuOpen(false)} />
