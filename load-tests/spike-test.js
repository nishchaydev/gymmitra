 ...
 * Some 429s are acceptable. Zero 500s allowed. No crashes.
 *
...
// Shared per-request params: timeout + tag (DRY)
const sharedParams = (name) => ({
    tags: { name },
    timeout: '12s', // Release stuck VUs after 12s so they don't pile up
});
...
export const options = {
    ...
    thresholds: {
        ...
        // Members endpoint often returns 429; has its own budget
