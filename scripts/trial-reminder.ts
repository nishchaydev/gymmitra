    ...
    for (const gym of trialGyms) {
        ...
        if (daysLeft === 30) {
            ...
            html = `<p>Hi ${gym.ownerName || 'Gym Owner'},</p>
                    <p>You've completed your first month with <strong>GymMitra</strong>! We hope you're enjoying the automated billing and member management.</p>
                    ...
                    <p>Best,<br/>Team GymMitra</p>`;
        } else if (daysLeft === 15) {
            subject = `15 Days Left in Your GymMitra Trial`;
            html = `<p>Hi ${gym.ownerName || 'Gym Owner'},</p>
                    <p>Your free trial of <strong>GymMitra</strong> expires in <strong>15 days</strong>.</p>
            ...
            html = `<p>Hi ${gym.ownerName || 'Gym Owner'},</p>
                    <p>Your <strong>GymMitra</strong> trial ends in exactly <strong>one week</strong>.</p>
            ...
            subject = `Final Day: Your GymMitra Trial Expires Tomorrow`;
            html = `<p>Hi ${gym.ownerName || 'Gym Owner'},</p>
            ...
            html = `<p>Hi ${gym.ownerName || 'Gym Owner'},</p>
                    <p>Your 1-month trial of <strong>GymMitra</strong> has officially expired.</p>
        ...
        if (subject && html) {
            ...
            if ((gym as any).lastTrialReminderMilestone === daysLeft) {
